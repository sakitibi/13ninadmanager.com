...
(async function(){
  ...
  await fetched();
  const selects = [
    { src: srcs[0], pat1: 486, publisher: 'メテヲs7のゆっくり実況部屋' }, // メテヲ
    { src: srcs[1], pat1: 723, publisher: 'Latte' }, // Latte
    { src: srcs[2], pat1: 938, publisher: 'ヒナの隠れ家' }, // ひなにい
    { src: srcs[3], pat1:1042, publisher: 'めめんともり' }, // めめんともり
    { src: srcs[4], pat1: 32, publisher: '原神-Genshin-公式' }, // 原神 Luna ⅠⅠ
    { src: srcs[5], pat1: 511, publisher: 'みぞれch' }, // みぞれ
    ...
    { src: srcs[10], pat1: 603, publisher: 'ゆっくりウパパロン' }, // ゆっくりウパパロン
    { src: srcs[11], pat1: 1076, publisher: '茶子 / ゆっくり実況' }, // 茶子 / ゆっくり実況
