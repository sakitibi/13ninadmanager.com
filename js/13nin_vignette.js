...
(async function(){
  ...
  await fetched();
  const selects = [
    { src: srcs[0], pat1: 512, publisher: 'メテヲs7のゆっくり実況部屋' }, // メテヲ
    { src: srcs[1], pat1: 859, publisher: 'Latte' }, // Latte
    { src: srcs[2], pat1: 883, publisher: 'ヒナの隠れ家' }, // ひなにい
    { src: srcs[3], pat1: 914, publisher: 'めめんともり' }, // めめんともり
    { src: srcs[4], pat1: 31, publisher: '原神-Genshin-公式' }, // 原神 Luna Ⅰ
    { src: srcs[5], pat1: 604, publisher: 'みぞれch' }, // みぞれ
    ...
    { src: srcs[10], pat1: 648, publisher: 'ゆっくりウパパロン' }, // ゆっくりウパパロン
    { src: srcs[11], pat1: 890, publisher: '茶子 / ゆっくり実況' } // 茶子 / ゆっくり実況
  ];
