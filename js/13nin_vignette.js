...
(async function(){
  ...
  const selects = [
    ...
    { src: srcs[2], pat1: 898, publisher: 'ヒナの隠れ家', site: `${site_baseurl}IwV62n9DIUgcOfQSYSPBSWPsnSAypR-NJG6LVjSzRImGzvrKjyVEqoM7hC7Gil-O7QJ_3bj7WnpOKQEvkcyu7Nxtl4tgT8GdrVl5cdamSzhmEufQKkpDr4YwIzDZ79I54aW42c_kQZsQZvmCCw165t4SUmMFh0bP7uePJlyCaXBB3mtHuMyroZk9` }, // ひなにい
    { src: srcs[3], pat1: 1160, publisher: 'めめんともり', site: `${site_baseurl}TKQVLhl2WhWwQ82S6OqY3-vXny3k3cs-ORby3iXuGvRjwtU6L8kVnCrFv2QHgoop-KxTovTdn6d_QRjqZFWAI7WsHmLLOTkVhY2tAujmyUouoBcNUOzwfj` }, // めめんともり
