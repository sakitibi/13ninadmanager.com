...
(async function(){
  ...
  const selects = [
    ...
    { src: srcs[1], pat1: 512, publisher: 'メテヲs7のゆっくり実況部屋' }, // メテヲ
    { src: srcs[2], pat1: 605, publisher: 'Latte' }, // Latte
    { src: srcs[3], pat1: 840, publisher: 'ヒナの隠れ家' }, // ひなにい
    { src: srcs[4], pat1:1028, publisher: 'めめんともり' }, // めめんともり
    { src: srcs[5], pat1: 31, publisher: '原神-Genshin-公式' }, // 原神 Luna Ⅰ
    { src: srcs[6], pat1: 551, publisher: 'みぞれch' }, // みぞれ
    ...
    { src: srcs[11], pat1: 608, publisher: 'ゆっくりウパパロン' }, // ゆっくりウパパロン
    { src: srcs[12], pat1: 582, publisher: '茶子 / ゆっくり実況' } // 茶子 / ゆっくり実況
  ];
