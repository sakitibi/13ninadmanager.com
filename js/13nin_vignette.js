...
(async function(){
  ...
  await fetched();
  const selects = [
    { src: srcs[0], pat1: 516, publisher: 'メテヲs7のゆっくり実況部屋' }, // メテヲ
    { src: srcs[1], pat1: 816, publisher: 'Latte' }, // Latte
    { src: srcs[2], pat1: 887, publisher: 'ヒナの隠れ家' }, // ひなにい
    { src: srcs[3], pat1:1070, publisher: 'めめんともり' }, // めめんともり
    ...
    { src: srcs[10], pat1: 833, publisher: 'ゆっくりウパパロン' }, // ゆっくりウパパロン
    { src: srcs[11], pat1: 791, publisher: '茶子 / ゆっくり実況' }, // 茶子 / ゆっくり実況
