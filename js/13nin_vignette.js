...
(async function(){
  ...
  await fetched();
  const selects = [
    { src: srcs[0], pat1: 796, publisher: 'メテヲs7のゆっくり実況部屋' }, // メテヲ
    { src: srcs[1], pat1: 618, publisher: 'Latte' }, // Latte
    { src: srcs[2], pat1: 917, publisher: 'ヒナの隠れ家' }, // ひなにい
    { src: srcs[3], pat1: 964, publisher: 'めめんともり' }, // めめんともり
    ...
    { src: srcs[10], pat1: 844, publisher: 'ゆっくりウパパロン' }, // ゆっくりウパパロン
    { src: srcs[11], pat1: 827, publisher: '茶子 / ゆっくり実況' }, // 茶子 / ゆっくり実況
    { src: srcs[12], pat1: 18, publisher: 'WECARS ウィーカーズ' }, // Wecars5
    { src: srcs[13], pat1: 18, publisher: 'WECARS ウィーカーズ' }, // Wecars6
    { src: srcs[14], pat1: 18, publisher: 'WECARS ウィーカーズ' }, // Wecars7
  ];
