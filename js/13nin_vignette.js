...
(async function(){
  ...
  await fetched();
  const selects = [
    { src: srcs[0], pat1: 487, publisher: 'メテヲs7のゆっくり実況部屋' }, // メテヲ
    { src: srcs[1], pat1: 830, publisher: 'Latte' }, // Latte
    { src: srcs[2], pat1: 917, publisher: 'ヒナの隠れ家' }, // ひなにい
    { src: srcs[3], pat1:1039, publisher: 'めめんともり' }, // めめんともり
    ...
    { src: srcs[10], pat1: 736, publisher: 'ゆっくりウパパロン' }, // ゆっくりウパパロン
