...
(async function(){
  ...
  await fetched();
  const selects = [
    { src: srcs[0], pat1: 527, publisher: 'メテヲs7のゆっくり実況部屋' }, // メテヲ
    { src: srcs[1], pat1: 830, publisher: 'Latte' }, // Latte
    { src: srcs[2], pat1: 872, publisher: 'ヒナの隠れ家' }, // ひなにい
    { src: srcs[3], pat1:1040, publisher: 'めめんともり' }, // めめんともり
    ...
    { src: srcs[10], pat1: 811, publisher: 'ゆっくりウパパロン' }, // ゆっくりウパパロン
