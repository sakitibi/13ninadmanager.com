...
(async function(){
  ...
  const selects = [
    ...
    { src: srcs[5], pat1: 528, publisher: 'みぞれch', site: `${site_baseurl}F0qm-fkYK8ZZN8jnr077MMu4Zl9E8rhmEeimB_ax8KJcy6UqhzbhqgbG6FtPsr3G3kerRXU7KFP-39-V0QRb7CNZojGyK2Xe2pXsDc7W2m6nVjZmcYeHRL` }, // みぞれ
    ...
    { src: srcs[11], pat1: 649, publisher: '茶子 / ゆっくり実況', site: `${site_baseurl}DFtDSz_Gd9ln2mtRBn3jGzy8gk8ofJpOEsD5zUEV87csq3epjwwziPdP6Lf6vbjzeBOLC61WPfqPMI4NMg56-MT-nLYX9RkPfBTkf3XYxeW56l3krEwjgmI` }, // 茶子 / ゆっくり実況
    ...
    { src: srcs[16], pat1: 3313, publisher: 'あかさかの箱', site: `${site_baseurl}CcRpgdMOX_yg1YHmtNaeR8unSC4ob_apwt64QDEP2EaWP3MNp5G4P4ZP5qF1ZGHSUpkck5GjxOf78KcZExWdowtCnIHj3XvcKYC17SKwCN9MkuKj660oQMomuvNtJB8iOF8_H400vG_ixVlEW94gN3bnH6XH0BX1zuzUB4ytgxiafpwb_x` }, // あかさかの箱
  ];
